...
public class Drug {
	...
	public Date getProdeced_date() {
		return prodeced_date;
	}

	public void setProdeced_date(Date prodeced_date) {
	...
	public String toString() {
		return "Drug [id=" + id + ", drug_num=" + drug_num + ", drug_url=" + drug_url + ", purchas_price="
				+ purchas_price + ", sale_price=" + sale_price + ", drug_name=" + drug_name + ", drug_type=" + drug_type
