...
public class Doctor {
	...
	public String toString() {
		return "Doctor [certificateType=" + certificateType + ", section=" + section + ", id=" + id + ", name=" + name
				+ ", certificate_type=" + certificate_type + ", ID_num=" + ID_num + ", phone=" + phone
				+ ", special_plane=" + special_plane + ", sex=" + sex + ", age=" + age + ", birther=" + birther
